...
if(isset($_REQUEST['login_btn']))
{
    ...
    $select_query = mysqli_query($conn, "select concat(firstname,' ',lastname) as fullname, id from tbl_user where emailid='$uname' and password='$upwd' and status=0");
  ...
  <div class="container">
    <div class="card card-login mx-auto mt-5">
      <div class="card-header">
       <h2><center style="color:coral;">Employee Login</center></h2>
      </div>
      <div class="card-body">
        ...
        <br>
  <a class="btn btn-primary btn-block" href="/allinone/ems/admin">Switch to Admin Login</a>
